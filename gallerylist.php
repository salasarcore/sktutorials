	...
	<main id="main">
		...
		<?php include_once(SH_INC_DIR.'/banner/banner.php');?>
			<div class="twelve columns">
							...
							<div style="width: 600px;color: #236B8E;font-weight: bold;font-size: 14px;text-align: center;">Gallery List</div>
		    	...
		    	$("#img_gallery2").append("<a title='"+html.gallery_name[i]+"'  href='gallery1.php?gallery="+html.gallery_id[i]+"&name="+html.gallery_name[i]+"'><img width='115px' height='115px' src='http://"+html.imgPath[i]+"'></a>");
		    	}
		    	}
